...
class MockZendeskClient {
  ...
  async getWindowedCounts() {
    ...
    return {
      ...
      reopened: { '1d': this.v(2, 0.8), '7d': this.v(8, 0.5), '30d': this.v(15, 0.4) },
    };
  }
  ...
  async getQualityMetrics() {
    await this.delay();
    const result = {};
    const configs = { '1d': { solved: 40, oneTouch: 20, replies: 2.5, wait: 5400, sample: 35 }, '7d': { solved: 280, oneTouch: 140, replies: 2.7, wait: 6600, sample: 180 }, '30d': { solved: 1200, oneTouch: 600, replies: 2.9, wait: 7200, sample: 200 } };
